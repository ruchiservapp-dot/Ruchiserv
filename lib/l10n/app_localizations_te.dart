...
class AppLocalizationsTe extends AppLocalizations {
  ...
  @override
  String get firmId => 'ఫర్మ్ ID';

  @override
  String get enterFirmId => 'ఫర్మ్ IDని నమోదు చేయండి';

  @override
  String get mobileNumber => 'మొబైల్ సంఖ్య';

  @override
  String get enterMobile => 'మొబైల్ నంబర్‌ను నమోదు చేయండి';
  ...
  @override
  String get enableBiometricLogin => 'బయోమెట్రిక్ లాగిన్‌ని ప్రారంభించండి';

  @override
  String get enableBiometricPrompt =>
      'తదుపరిసారి వేగవంతమైన లాగిన్ కోసం మీరు బయోమెట్రిక్ ప్రమాణీకరణను ప్రారంభించాలనుకుంటున్నారా?';
  ...
  String failedEnableBiometric(String error) {
    return 'బయోమెట్రిక్‌లను ప్రారంభించడంలో విఫలమైంది: $error';
  }

  @override
  String get biometricNotAllowed =>
      'బయోమెట్రిక్ లాగిన్ అనుమతి లేదు. దయచేసి ఆన్‌లైన్‌లో ఒకసారి లాగిన్ చేయండి.';
  ...
  @override
  String get subscription => 'సబ్స్క్రిప్షన్';

  @override
  String get subscriptionExpired =>
      'మీ సబ్స్క్రిప్షన్ గడువు ముగిసింది. కొనసాగడానికి దయచేసి పునరుద్ధరించండి.';

  @override
  String subscriptionExpiresIn(int days) {
    return 'మీ సబ్స్క్రిప్షన్ $days రోజుల్లో ముగుస్తుంది. దయచేసి పునరుద్ధరించండి.';
  }
  ...
  String get offlineLoginNotAllowed =>
      'ఆఫ్‌లైన్ లాగిన్ అనుమతించబడదు. దయచేసి ఇంటర్నెట్‌కి కనెక్ట్ చేయండి。';
