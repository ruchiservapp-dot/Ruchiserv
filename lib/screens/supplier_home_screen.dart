            ...
            children: [
              ...
              Expanded(
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text('Welcome,', style: TextStyle(color: Colors.white.withValues(alpha: 0.8), fontSize: 12)),
                ...
                child: Container(
                  ...
                  child: Column(
                    children: [
                      ...
                      Text('POs This Month', style: TextStyle(color: Colors.white.withValues(alpha: 0.8), fontSize: 10)),
                    ],
                  ),
                ),
              ),
                ...
                child: Container(
                  ...
                  child: Column(
                    children: [
                      ...
                      Text('Total Value', style: TextStyle(color: Colors.white.withValues(alpha: 0.8), fontSize: 10)),
                    ],
                  ),
                ),
              ),
