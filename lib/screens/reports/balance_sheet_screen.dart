              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    // Assets Section
                    _buildSectionHeader(
                        'Assets', Icons.account_balance_wallet, Colors.green),
                    const SizedBox(height: 8),
                    Card(
                      child: Column(
                        children: [
                          _buildLineItem(
                              'Cash & Bank', assets['cash'] ?? 0, Colors.green),
                          const Divider(height: 1),
                          _buildLineItem('Accounts Receivable (AR)',
                              assets['accountsReceivable'] ?? 0, Colors.blue),
                          const Divider(height: 1),
                          _buildLineItem('Inventory', assets['inventory'] ?? 0,
                              Colors.orange),
                          const Divider(height: 1),
                          _buildTotalItem('Total Assets', assets['total'] ?? 0,
                              Colors.green),
                        ],
                      ),
                    ),
                    ...
                    // Liabilities Section
                    _buildSectionHeader(
                        'Liabilities', Icons.credit_card, Colors.red),
                    const SizedBox(height: 8),
                    Card(
                      child: Column(
                        children: [
                          _buildLineItem('Accounts Payable (AP)',
                              liabilities['accountsPayable'] ?? 0, Colors.red),
                          const Divider(height: 1),
                          _buildLineItem('GST Payable',
                              liabilities['gstPayable'] ?? 0, Colors.orange),
                          const Divider(height: 1),
                          _buildTotalItem('Total Liabilities',
                              liabilities['total'] ?? 0, Colors.red),
                        ],
                      ),
                    ),
                  ],
