...
class _DriverHomeScreenState extends State<DriverHomeScreen> {
  ...
  void initState() {
    super.initState();
    AppLogger.info("📍 DriverHomeScreen: initState start");
    _loadDriverData();
    _checkPermission();
    AppLogger.info("📍 DriverHomeScreen: initState end");
  }

  Future<void> _checkPermission() async {
    AppLogger.info("📍 DriverHomeScreen: _checkPermission start");
  ...
  Future<void> _loadDriverData() async {
    ...
    try {
      ...
      if (vehicleRes.isNotEmpty) {
        ...
        AppLogger.info("📍 DriverHomeScreen: Vehicle identified: $_driverId");
        await _loadDispatchData();
      } else {
        AppLogger.info("📍 DriverHomeScreen: No vehicle assigned for $mobile");
        if (mounted) {
          setState(() {
            _pendingAssignments = [];
  ...
  Future<void> _loadDispatchData() async {
    ...
    try {
      ...
      AppLogger.info("📍 Error loading dispatch data: $e");
    }
    final db = await DatabaseHelper().database;
