            ...
            children: [
              ...
              Expanded(
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text('Welcome back,', style: TextStyle(color: Colors.white.withValues(alpha: 0.8), fontSize: 12)),
                ...
                child: Container(
                  ...
                  child: Column(
                    children: [
                      ...
                      Text('This Month Orders', style: TextStyle(color: Colors.white.withValues(alpha: 0.8), fontSize: 10)),
                    ],
                  ),
                ),
              ),
                ...
                child: Container(
                  ...
                  child: Column(
                    children: [
                      ...
                      Text('Total Pax', style: TextStyle(color: Colors.white.withValues(alpha: 0.8), fontSize: 10)),
                    ],
                  ),
                ),
              ),
