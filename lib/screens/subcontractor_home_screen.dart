...
import 'subcontractor_ledger_screen.dart';
        ...
        Expanded(
          child: _actionCard('Calendar', Icons.calendar_month, Colors.blue, () {
            Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (_) => SubcontractorCalendarScreen(
        ...
        Expanded(
          child: _actionCard(
            ...
            Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (_) => SubcontractorLedgerScreen(
                      subcontractorId: _subcontractorId,
    ...
    return Column(
      ...
      children: [
        ...
        if (_todayOrders.isEmpty)
          ...
          ...List.generate(
              _todayOrders.length, (i) => _buildOrderCard(_todayOrders[i])),
      ],
    );
  }
  ...
  Widget _buildOrderCard(Map<String, dynamic> order) {
    return Card(
      ...
      child: ListTile(
        ...
        subtitle: Text(
            '${order['dishName']} • ${order['pax']} pax • ${TimeUtils.formatTo12Hour(order['time'])}'),
