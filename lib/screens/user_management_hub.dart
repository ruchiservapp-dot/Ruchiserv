  ...
  void _handleSupplierAction(
    ...
    switch (action) {
      ...
      case 'toggle':
        ...
        break;
      case 'delete':
        await dbHelper.deleteSupplier(supplier['id'] as int);
        _loadData();
        break;
    }
  }
  ...
  void _handleSubcontractorAction(
    ...
    switch (action) {
      ...
      case 'rate':
        ...
        break;
      case 'delete':
        await dbHelper.deleteSubcontractor(sub['id'] as int);
        _loadData();
        break;
    }
  }
            ...
            ElevatedButton(
              onPressed: () async {
                ...
                try {
                  ...
                  AppLogger.info('ERROR ADDING USER: $e');
          ...
          ElevatedButton(
            onPressed: () async {
              ...
              if (existing == null) {
                ...
                await dbHelper.insertSupplier(data);
              } else {
        ...
        actions: [
          ...
          ElevatedButton(
            onPressed: () async {
              ...
              if (existing == null) {
                data['createdAt'] = DateTime.now().toIso8601String();
                await dbHelper.insertSubcontractor(data);
              } else {
