...
class _SupplierCalendarScreenState extends State<SupplierCalendarScreen> {
  ...
  void _onDaySelected(DateTime selectedDay, DateTime focusedDay) {
    ...
    if (_calendarData.containsKey(dateKey)) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
            content: Text(
                '${_calendarData[dateKey]!['poCount']} POs on ${DateFormat('MMM d').format(selectedDay)}')),
      );
    }
  }
  ...
  Widget _buildDayCell(DateTime day,
    ...
    if (hasPOs) {
      bgColor =
          totalAmount > 10000 ? Colors.green.shade100 : Colors.teal.shade50;
    }
