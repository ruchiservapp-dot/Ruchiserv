...
// @locked
// lib/screens/create_firm_screen.dart
...
class _CreateFirmScreenState extends State<CreateFirmScreen> {
  ...
  Future<void> _createFirmAndAdmin() async {
    ...
    try {
      ...
      AppLogger.info('🔄 Attempting AWS sync for firm: $_generatedFirmId');
      String successMsg = 'Firm created successfully!';
      ...
      try {
        ...
        AppLogger.info('🔴 AWS sync FAILED: $e');
        AppLogger.info('🔴 Stack trace: $stack');
        syncFailed = true;
        successMsg = 'Firm created LOCALLY. Internet required for Full Sync.';
      }
