...
class _SupplierLedgerScreenState extends State<SupplierLedgerScreen> {
                    ...
                    onScanComplete: (result) async {
                      ...
                      try {
                        ...
                        final Map<String, dynamic> txn = {
                          ...
                          'category': 'PURCHASE',
                          'description': 'Scanned Invoice from Supplier Portal',
                          'mode': 'Pending',
                          'partyName': widget.supplierName,
                          'referenceId': 'SUPPLIER:${widget.supplierId}',
  ...
  void _viewInvoice(String? imageUrl) {
    showS3ImageDialog(context, imageUrl, title: 'Invoice Image');
  }
}
