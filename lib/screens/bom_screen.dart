...
class _BomScreenState extends State<BomScreen> {
  ...
  Future<void> _editBom(Map<String, dynamic> dish) async {
    ...
    final bom = await InventoryRepository().getBomForDish(_firmId!, dishId);
    final ingredients = await InventoryRepository().getAllIngredients(_firmId!);
          ...
          actions: [
            ...
            ElevatedButton.icon(
              ...
              onPressed: () async {
                ...
                await OrderRepository().upsertDishMaster(
                              ...
                              trailing: Row(
                                ...
                                children: [
                                  FutureBuilder<List<Map<String, dynamic>>>(
                                    future: InventoryRepository().getBomForDish(_firmId!, dish['id']),
            ...
            actions: [
              ...
              ElevatedButton.icon(
                ...
                onPressed: () async {
                  ...
                  await InventoryRepository().insertBomItem({
